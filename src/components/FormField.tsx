...
const STYLE = {
  primary:
    'tap h-12 w-full rounded-full bg-brand px-4 text-sm font-bold text-on-brand shadow-card disabled:opacity-50 disabled:saturate-50',
  ...
  add: 'tap flex min-h-11 items-center gap-1.5 whitespace-nowrap rounded-full bg-brand px-4 text-sm font-bold text-on-brand shadow-card disabled:opacity-50',
} as const
